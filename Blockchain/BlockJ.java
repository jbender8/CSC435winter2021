...
public class BlockJ {
    ...
    public void run(String argv[]) {
        ...
        try { // Remove the try block to see all the exceptions that might be raised in the
              // method
    ...
    public void DemonstrateUtilities(String args[]) throws Exception {
        ...
        /*
         * Later you'll add this SHA256String to the header for the block. Here we turn
         * the byte[] signature into a string so that it can be placed into the block as
         * a string, but also show how to return the string to a byte[], which you'll
         * need if you want to use it later. Thanks Hugh Thomas for the fix!
         */
        ...
        /*
         * In this section we show that the public key can be converted into a string
         * suitable for marshaling in XML or JSON to a remote machine, but then
         * converted back into usable public key. Then, just for added assurance, we
         * show that if we alter the string, we can convert it back to a workable public
         * key in the right format, but it fails our verification test.
         */
        ...
        /*
         * CDE: In case you want to use it for something, here we encrypt a string, then
         * decrypt it, using the same public key technology. These techniques are not
         * needed for the basic CSC435 assignment. Note that this methocd is intended
         * for 117 bytes or less to pass session keys:
         */
